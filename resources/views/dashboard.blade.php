      ...
      <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="page-header">
                  <h2 class="pageheader-title">@if (Auth::user()->isAdmin())
                    Admin Dashboard
                @else
                    Employee Dashboard
                @endif </h2>
                  ...
                  <div class="page-breadcrumb">
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Juniper Distilling Dashboard</li>
                          </ol>
                      </nav>
                  </div>
              </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                              <span><i class="fa fa-fw fa-arrow-down"></i></span><span>2.25%</span>
                          </div>
                      </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($reservation->guests_total > 2)
                                                <span class="badge-dot badge-success mr-1"></span>Indoor
                                            @else 
                                                <span class="badge-dot badge-brand mr-1"></span>Outdoor
                                            @endif
                                         </td>
                                    </tr>
                                @endforeach
