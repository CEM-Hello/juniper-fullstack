  ...
  <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
              <h2 class="pageheader-title">Edit Cocktail Item </h2>
              <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
              <div class="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="/admin" class="breadcrumb-link">Dashboard</a></li>
                          <li class="breadcrumb-item"><a href="/admin/cocktail-items" class="breadcrumb-link">All Cocktail Items</a></li>
                          <li class="breadcrumb-item active" aria-current="page">Edit Cocktail Item</li>
                      </ol>
                  </nav>
              </div>
          </div>
  ...
  <!-- ============================================================== -->
      ...
      <div class="row">
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
              <div class="card">
                  <h5 class="card-header">Edit Cocktail Item</h5>
                  <div class="card-body">
                    <form method="POST" action="/admin/cocktail-items/{{$item->id}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="inputdescription" type="text" class="form-control form-control-lg @error('description') is-invalid @enderror" name="description" autofocus placeholder="Write a Description">{{ old('description', $item->description) }}</textarea>
