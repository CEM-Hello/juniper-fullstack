                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/settings/social">
                                        ...
                                        <div class="form-group">
                                            <label for="inputyelp_url">Yelp Profile URL</label>
                                            <input id="inputyelp_url" type="text" class="form-control form-control-lg @error('yelp_url') is-invalid @enderror" name="yelp_url" value="{{ old('yelp_url', $social_setting->yelp_url) }}" required autocomplete="yelp_url" autofocus placeholder="Add Yelp Profile">
